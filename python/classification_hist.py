...
linetypes = ['solid', 'dotted', 'dashdot', 'dashed']
colours = ['b', 'r', 'g', 'm']

fig,ax = plt.subplots(1,1,figsize=(8,8))
for n in range(4):
	ax.hist(data[samps[n]]['t01_smooth_or_features_total_count'],bins=range(170),histtype='step',lw=2, color=colours[n], linestyle=linetypes[n])
	ax.axhline((0.725+(0.2*(4-float(n))/4))*8000, 0.5, 0.55, linestyle=linetypes[n],color=colours[n], lw=2)
