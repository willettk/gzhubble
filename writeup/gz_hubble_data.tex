...
\caption{System throughput (fractional photon detection efficiency) of the
filters used by \hst{} Advanced Camera for Surveys (ACS) in wide-field channel
mode for the various surveys in GZH. The unfilled black curves show the filters
for the Suprime Camera on the \textit{Subaru} telescope, which was used to
create color gradients in the GZH images for COSMOS.\label{fig:filtercurves}}
\end{figure*}
