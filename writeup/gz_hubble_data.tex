...
regarding image modifications. \citet{sim14} uses similarly-processed
images for reliable identification of bulgeless galaxies using SDSS data.
...
\begin{figure*}
\centering
\subfigure{[a]\label{fig:bias_a}\includegraphics[width=0.5\textwidth]{figures/p_vs_p_SB_redshift.pdf}}
\subfigure{[b]\label{fig:bias_b}\includegraphics[width=0.4\textwidth]{figures/z1_mu20_subplot1.pdf}}
\\
\subfigure{[c]\label{fig:bias_c}\includegraphics[width=0.5\textwidth]{figures/orangebars.pdf}}
\subfigure{[d]\label{fig:bias_d}\includegraphics[width=0.4\textwidth]{figures/z1_mu20_subplot2.pdf}}
...
the images (see top right panel of Figure~\ref{fig:bias_a}).
...
Figure~\ref{fig:bias_a}. Any flat regions of the polynomial fits are areas in which
...
regions are highlighted in blue in Figure~\ref{fig:bias_a}. Uncolored (white)
...
\ffeaturesrest{} relationship, colored gray in Figure~\ref{fig:bias_a}.

The unshaded regions in Figure~\ref{fig:bias_a} define discrete ranges of redshift,
...
estimated using a method visualized in Figure~\ref{fig:bias_c}. This uses the
...
represented by the orange bars in Figure~\ref{fig:bias_c}. For any galaxy which
