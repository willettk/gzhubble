...
\begin{itemize}
    ...
    \item AEGIS morphologies \citep{lot08}
    \item GOODS N/S morphologies \citep{bun05}
\end{itemize}
...
Clumpy galaxies in GZH have $n$ and $R_e$ \galfit{} parameters more consistent with disky, $n<2.5$ galaxies than spheroids (Figure~\ref{fig:clumpy_gems}). 

\begin{figure}
\begin{center}
\includegraphics[width=0.50\textwidth]{figures/gems_clumpy.png}
\caption{Parameter distributions for GEMS galaxies in \citet{hau07} and GZH. Red and blue points indicate galaxies split by their \sersic~index into disk- and bulge-dominated galaxies. Galaxies identified as ``clumpy'' in GZH are labeled in green.}
