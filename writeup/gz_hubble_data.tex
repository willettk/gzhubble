...
\caption{Surface brightness vs. redshift of 3,950 \ferengi{} images and the 102,548 galaxies in the ACS sample which had measured values of $\mu$ and $z$. The color histogram counts the number of \ferengi{} images as a function of $\mu$ and $z_{\rm simulated}$. The white contours show counts for the ACS sample as a function of $\mu$ and $z$, with contours starting at N = 1000 and separated by 1000 up to 7000.} 
