...
03       & bar		        & 01, 12, 02          & $p_{\rm edgeon,no}>0.25$                 \\
         &                      & 01, 12, 16, 15      & $p_{\rm arrangement,spiral}>0.65$         \\
04       & spiral arms          & 01, 12, 02          & $p_{\rm edgeon,no}>0.25$                  \\
         &                      & 01, 12, 16, 15      & $p_{\rm arrangement,spiral}>0.65$         \\
05       & bulge prominence     & 01, 12, 02          & $p_{\rm edgeon,no}>0.25$                 \\
         &                      & 01, 12, 16, 15      & $p_{\rm arrangement,spiral}>0.65$         \\
06       & odd yes/no           & -                   &                   \\
07       & rounded              & 01                  & $p_{\rm smooth}>0.7$               \\
08       & odd feature          & 06                  & $p_{\rm odd,yes}> 0.5 $                  \\
09       & bulge shape          & 01, 12, 02          & $p_{\rm edgeon,yes}>0.4$               \\
...
13       & bright clump         & 01, 12, 16          & $p_{\rm one~clump}< 0.4$                 \\
14       & bright central clump & 01, 12, 16, 13      & $p_{\rm bright~clump,yes}>0.5$           \\
15       & clump arrangement    & 01, 12, 16          & $p_{\rm multiple~clumps}>0.45$                \\
16       & clump count          & 01, 12              & $p_{\rm clumpy,yes}>0.8$              \\
17       & clumps symmetrical   & 01, 12              & $p_{\rm clumpy,yes}>0.8$                \\
18       & clumps embedded      & 01, 12              & $p_{\rm clumpy,yes}>0.8$                 \\
