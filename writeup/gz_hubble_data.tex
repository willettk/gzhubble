...
\altaffiltext{3}{School of Physics and Astronomy, University of Nottingham, UK}
\altaffiltext{4}{Oxford Astrophysics, University of Oxford, UK}
\altaffiltext{5}{Institute of Cosmology and Gravitation, University of Portsmouth, UK}
\altaffiltext{6}{SEPnet, South East Physics Network, UK}
\altaffiltext{7}{Center for Astrophysics and Space Sciences, UC San Diego, USA}
\altaffiltext{8}{Department of Mathematics and Science, Wheelock College, USA}
\altaffiltext{9}{Kavli Institute for the Physics and Mathematics of the Universe (WPI), Japan}
\altaffiltext{10}{Infrared Processing and Analysis Center, California Institute of Technology, USA}
\altaffiltext{11}{Department of Astronomy and Astrophysics, Pennsylvania State University, USA}
\altaffiltext{12}{Centre for Astrophysics, University of Hertfordshire, UK}
\altaffiltext{13}{European Southern Observatory, Santiago, Chile}
\altaffiltext{14}{Department of Astronomy, Yale University, USA}
\altaffiltext{15}{Adler Planetarium, USA}
\altaffiltext{16}{Institute for Astronomy, ETH Z\"urich, Switzerland}
...
tasks as listed in Table~\ref{tbl:thresholds}. We identify 11,049 ``bar
candidates'' as disk galaxies for which bar identification can be attempted in
GZH. These galaxies were selected by applying the cuts $N_{bar} \ge 20$,
...
\acknowledgments
KW, MG, CS, MB, and LF gratefully acknowledge support from the US National Science
Foundation Grant AST1413610. KS gratefully acknowledges support from Swiss
National Science Foundation Grant PP00P2\_138979/1. The development and hosting of 
Galaxy Zoo Hubble was supported by a grant from the Alfred P. Sloan Foundation. 
The Zooniverse acknowledges support from a Google Global Impact Award. 
...
\url{http://sankeymatic.com/}. \citet{hol05} provided invaluable assistance
...
\caption{Galaxies whose shallow images were classified as smooth and full depth
images were classified as smooth, intermediate, or featured.}
...
\caption{Galaxies whose shallow images were classified as intermediate and full
