...
\tablecolumns{13}
\tablewidth{0pc}
\tablecaption{GZH morphological classifications for desaturated Hubble images} 
\label{tbl:catalog_desaturated}
\tabletypesize{\scriptsize}
\tablehead{
 & & & RA & dec  &  
\multicolumn{2}{c}{\underline{t01\_smooth\_or\_features\_}} &
...
\small
\startdata
AHZF000001  &   20000002    &   COSMOS  &   &   &   1   &   160 &  0.708   &     0.755   &   0.228    &    0.754 &   0.325 &   0.829  \\
AHZF000003  &   20000004    &   COSMOS  &   &   &   3   &   301 &  0.367   &     0.379   &   0.100    &    0.379 &   0.198 &   0.198  \\
AHZF000004  &   20000006    &   COSMOS  &   &   &   3   &   319 &  0.265   &     0.271   &   0.010    &    0.270 &   $-$	&   $-$    \\
AHZF00000z  &   20000102    &   COSMOS  &   &   &   1   &   150 &  0.727   &     0.78    &   0.233    &    0.780 &   0.316 &   0.820  \\
AHZF000010  &   20000104    &   COSMOS  &   &   &   2   &   164 &  0.811   &     0.849   &   0.904    &    0.848 &   $-$	&   $-$    \\
\enddata
...
\tablecolumns{13}
\tablewidth{0pc}
\tablecaption{GZH morphological classifications for color-inverted images} 
\label{tbl:catalog_inverted}
\tabletypesize{\scriptsize}
\tablehead{
 & & & RA & dec  &  
\multicolumn{2}{c}{\underline{t01\_smooth\_or\_features\_}} &
...
\tablecolumns{13}
\tablewidth{0pc}
\tablecaption{GZH morphological classifications for GOODS 2-epoch images} 
\label{tbl:catalog_desaturated}
\tabletypesize{\scriptsize}
\tablehead{
 & & & RA & dec  &  
