...
combination of \sextractor{} \citep{ber96} and the \sersic-profile fitting
...
$(0.2,1.0,2.0,5.0,10.0,50.0)$. This range was selected to run from AGN which
were all but undetectable through to those which dominate the galaxy, providing
coverage of all plausible effects. Combining these parameters generated
15~images with different simulated AGN for each host. 
...
SDSS targets that maximuze the coverage of parameter space. 
...
bias rests on the assumption that the \emph{degree} of bias is a function of
