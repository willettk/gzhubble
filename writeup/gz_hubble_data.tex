...
Needs: coordinate/location description.

So GZ:CANDELS overlaps with GZ:Hubble in GOODS-S and COSMOS. GZH doesn't 
...
\subsection{Morphological measurements in GZH beyond Task 1}
...
This project made heavy use of the Astropy packages in Python \citep{ast13}, as well as the seaborn plotting package \citep{was15}.
