...
\hl{The range of intrinsic values for GZH is defined as the inner 68\% of the data, corresponding to
where the upper and lower limits of this range correspond to} $\pm{1~\sigma}$ \hl{ above and 
below the mean. This range is represented by the orange bars in Figure}~\ref{fig:f_vs_f_zoom}. For any galaxy which
